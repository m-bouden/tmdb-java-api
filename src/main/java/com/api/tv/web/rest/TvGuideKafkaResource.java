...
@RestController
@RequestMapping("/api/tv-guide-kafka")
public class TvGuideKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TvGuideKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public TvGuideKafkaResource(KafkaProperties kafkaProperties) {
